...
final class MessageModelTests: XCTestCase {
    ...
    func testInitialValues() {
        ...
        let textMessage = Message(content: Constants.sampleUserPrompt, type: .text, isUserMessage: true)
        ...
        let imageMessage = Message(content: Constants.sampleImageURL, type: .image, isUserMessage: true)
